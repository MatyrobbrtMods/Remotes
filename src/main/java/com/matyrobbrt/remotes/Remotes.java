...
public class Remotes {
    ...
    public static final RegistryObject<Item> BLOCK_REMOTE = ITEMS.register("block_remote", () -> new BlockRemoteItem(new Item.Properties().stacksTo(1)));
    ...
    public Remotes() {
        ...
        modEventBus.addListener((final CreativeModeTabEvent.BuildContents event) -> {
            if (event.getTab() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
                event.accept(BLOCK_REMOTE.get().getDefaultInstance());
            }
        });
    }
